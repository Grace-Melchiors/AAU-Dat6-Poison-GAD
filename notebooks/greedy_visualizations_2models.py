...
elif DATASET_NAME == 'Wiki' or DATASET_NAME == 'Cora' or DATASET_NAME == 'Facebook' or DATASET_NAME == 'Amazon':
    dataset, prior_labels = load_injected_dataset(DATASET_NAME)
    print("CITESEER ADJ: ", dataset.edge_index)
...
print("THIS IS THE TARGET LIST PASSED: ", target_list)
_, AS_1, AS_DOM_1, AUC_DOM_1, ACC_DOM_1, perturb_1, edge_index_1, CHANGE_IN_TARGET_NODE_AS_1, LAST_FEAT_LOSS, LAST_STRUCT_LOSS, ALL_AS = greedy_attack_with_statistics_multi(
    model, triple, DominantJaccard, dom_params, config, target_list, budget, print_stats = True, DOMINANT_model_2=DominantMedoid)
...
plot_anomaly_scores(CHANGE_IN_TARGET_NODE_AS_1[0], "Unmodified DOMINANT", title="Anomaly Score Development for Each Node (CiteSeer)")
plot_anomaly_scores(CHANGE_IN_TARGET_NODE_AS_1[1], "CamoBlock")
...
# %%
plot_scores(AS_DOM_1[0], AS_DOM_1[1], "Sum of Target Nodes Anomaly Scores by Budget (CiteSeer)", "Budget", "Anomaly Score")
plot_scores(AUC_DOM_1[0], AUC_DOM_1[1], "AUC-ROC by Budget (CiteSeer)", "Budget", "AUC-ROC")
...
plot_scores(AUC_DOM_1[0], AUC_DOM_1[1], "AUC-Score by Budget (CiteSeer)", "Budget", "Anomaly Score", scores3=AUC_DOM_1[2], scores4=AUC_DOM_1[3])
plot_scores(AS_DOM_1[0], AS_DOM_1[1], "Sum of Target Nodes Anomaly Scores by Budget (CiteSeer)", "Budget", "Anomaly Score", scores3=AS_DOM_1[3])
# %%
...
def plot_AS_scores_over_budgets(AS_scores, targets, y_min=0, y_max=None, model='Dominant'):
    plt.title(f'{model}: Anomaly Score Ranking (CiteSeer)')
    ...
    if y_max is not None:
        ...
        plt.ylim(y_min, max(max(AS_placings), y_min))

    plt.show()

target_list = [217, 333, 289, 581, 1808, 2375, 619, 1885, 670, 1728]

plot_AS_scores_over_budgets(ALL_AS[0], target_list, y_max=3327, model='Unmodified DOMINANT')
plot_AS_scores_over_budgets(ALL_AS[1], target_list, y_max=3327, model='DOMINANT w/ CamoBlock')


# %%

#dimensions OF CHANGE IN TARGET NODE AS 2d array
print(CHANGE_IN_TARGET_NODE_AS_1[0])
print(len(AS_DOM_1[0]))
...
#save_results('results_citeseer_jaccard_medoid.pkl', AS_1, AS_DOM_1, AUC_DOM_1, ACC_DOM_1, perturb_1, edge_index_1, CHANGE_IN_TARGET_NODE_AS_1, LAST_FEAT_LOSS, LAST_STRUCT_LOSS, ALL_AS)
...
plot_scores(AS_DOM_1[0], AS_DOM_1[1], "Sum of Target Nodes Anomaly Scores by Budget (CiteSeer)", "Budget", "Anomaly Score", AS_DOM_2[0], AS_DOM_2[1])
plot_scores(AUC_DOM_1[0], AUC_DOM_1[1], "AUC-ROC by Budget (CiteSeer)", "Budget", "AUC-ROC", AUC_DOM_2[0], AUC_DOM_2[1])
# %%
