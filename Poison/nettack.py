...
from base_classes import Poison



class Nettack(Poison):
    def __init__(self, model, labels, adj, attr, nnodes=None, attack_structure=True, attack_features=False, device='cpu'):

        super(Nettack, self).__init__(adj, attr, labels, nnodes, attack_structure, attack_features)
